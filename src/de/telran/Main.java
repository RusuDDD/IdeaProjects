...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isPalindrom("helleh"));//true
        System.out.println(isPalindrom("helle"));//false
        ...
        System.out.println(cutString("hello world guys", 5));//"helllo"
        System.out.println(cutString("hello world guys", 6));//"helllo"
        System.out.println(cutString("hello world guys", 7));//"helllo"
