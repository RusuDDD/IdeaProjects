...
// Komparator ato pattern programirovanie, olitsetvoreaiuschii pravila , po katoramu sravnivaiutsea para odnotipnih obiectov
// na predmet ih poreadca (bolishe menishe)
public class Main {
