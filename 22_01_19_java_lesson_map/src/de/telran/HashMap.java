...
// TODO investigate and coplete and test
public class HashMap<K, V> implements Map<K, V> {
    ...
    public V put(K key, V value) {
        ...
        /**
         * find the pair with the key or null if there is no pair with such of key
         *
         * @param key
         * @return
         */
